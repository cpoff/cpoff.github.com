    ...
    print
        ...
        <div id="content">
            ...
            <form name="form" action="edit_comment.php" method="post">
                ...
                <div class="buttons">
                    <input type="submit" name="submit_save" value="Save" class="submit-primary" />&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" OnClick="window.location=\'' . URL_SCHEME . HOSTNAME . OUTPUT_PATH . h(escape_javascript(get_page_name($page_id))) . h(escape_javascript(get_query_string_for_page_url($page_type, $item_id, $item_type))) . '#c-' . h(escape_javascript($_GET['id'])) . '\';" class="submit-secondary" />&nbsp;&nbsp;&nbsp;<input type="submit" name="submit_delete" value="Delete" class="delete" onclick="return confirm(\'WARNING: This comment will be permanently deleted.\')" />
                </div>
            </form>
        </div>' .
        output_footer();
