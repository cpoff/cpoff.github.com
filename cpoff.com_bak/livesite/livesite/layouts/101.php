                ...
                <div class="credit_debit_card" style="display: none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-option">
                        	...
                        	<select name="card_type" id="card_type"></select>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-option">
                            <i class="ti-angle-down"></i>
                        	<select name="expiration_month" id="expiration_month"></select>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                    <div class="form-group">
                        <label for="expiration_month">Exp. Year*</label>
                        <div class="select-option">
                            <i class="ti-angle-down"></i>
                        	<select name="expiration_year" id="expiration_year"></select>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="card_verification_number" id="card_verification_number" class="form-control" style="width:6em">
