...
if ((isset($_SESSION['software']['view_email_campaign_profiles']['query']) == true) && ($_SESSION['software']['view_email_campaign_profiles']['query'] != '')) {
    $where .= "WHERE (LOWER(CONCAT_WS(',', email_campaign_profiles.name, email_campaign_profiles.action, email_campaign_profiles.subject, created_user.user_username, last_modified_user.user_username)) LIKE '%" . escape(mb_strtolower($_SESSION['software']['view_email_campaign_profiles']['query'])) . "%')";
}
