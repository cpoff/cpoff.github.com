    ...
    function output_field($attributes) {
        ...
        switch ($type) {
            ...
            case 'number':
                ...
                return "<input type=\"$type\" name=\"" . h($field) . "\" id=\"" . h($id) . "\" value=\"" . h($value) . "\" size=\"$size\" class=\"$class\" style=\"$style\"$output_readonly$output_onchange$output_onclick$output_onfocus$output_onblur$output_min$output_max" . $output_placeholder . $output_required . $output_maxlength . $autocomplete . $autofocus . $spellcheck . ">";
                break;
