...
switch ($filter) {
    ...
    case 'my_login_pages':
        ...
        // Set the query filter.
        $where .= ' (page_type = "registration entrance" OR page_type = "registration confirmation" OR page_type = "membership entrance" OR page_type = "membership confirmation" OR page_type = "forgot password" OR page_type = "login" OR page_type = "logout" OR page_type = "login" OR page_type = "change random password")';
    ...
    for ($key = $start; $key <= $end; $key++) {
        ...
        $output_rows .=
            '<tr>
                ...
                <td class="pointer" onclick="window.location.href=\'' . $output_link_url . '\'">' . h($pages[$key]['folder_name']) . '</td>
