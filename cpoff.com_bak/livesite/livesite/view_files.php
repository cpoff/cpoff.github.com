...
if ($files) {
    ...
    for ($key = $start; $key <= $end; $key++) {
        ...
        if ((mb_strtolower($files[$key]['type']) == 'bmp') || (mb_strtolower($files[$key]['type']) == 'gif') || (mb_strtolower($files[$key]['type']) == 'jpg') || (mb_strtolower($files[$key]['type']) == 'jpeg') || (mb_strtolower($files[$key]['type']) == 'png') || (mb_strtolower($files[$key]['type']) == 'tif') || (mb_strtolower($files[$key]['type']) == 'tiff')) {
            ...
            // Output thumnail.
            $output_thumbnail = '<img src="' . OUTPUT_PATH . h($files[$key]['name']) . '" width="' . $thumbnail_dimensions['width'] . '" height="' . $thumbnail_dimensions['height'] . '" alt="" title="Image Size: ' . $output_image_dimensions . '" />';
        } else {
            $output_thumbnail = '';
        ...
        $output_rows .=
            '<tr>
                ...
                <td class="' . $output_pointer_class . $output_design_class . '"' . $output_link . '>' . h($files[$key]['folder_name']) . '</td>
