...
email(array(
    ...
    'body' =>
"Your password was reset by an administrator.  You can find your new, temporary password below.
...
$liveform_view_users->add_notice('The user\'s password has been reset, and a new, temporary password, &quot;' . h($random_password) . '&quot;, has been e-mailed to the user.');
