    ...
    print
        ...
        <html lang="en">
            ...
            <body class="pages">
                <div id="content">
                    <h1>Modify Pages</h1>
                    <div class="subheading" style="margin-bottom: 1em">You may update various properties below for the selected pages. You may leave a pick list unselected if you do not want to modify a property.</div>
                    <table class="field">
                        <tr>
                            <td>Folder:</td>
