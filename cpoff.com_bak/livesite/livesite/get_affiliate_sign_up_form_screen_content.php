        ...
        <form action="' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/affiliate_sign_up_form.php" method="post">
            ...
            <table style="margin-bottom: 15px">
                ...
                <tr>
                    ...
                    <td><div id="state_container">' . $liveform->output_field(array('type'=>'text', 'name'=>'state', 'id'=>'state', 'maxlength'=>'50', 'class'=>'software_input_text')) . '</div></td>
                </tr>
                <tr>
                    <td>Zip / Postal Code*</td>
                    <td>' . $liveform->output_field(array('type'=>'text', 'name'=>'zip_code', 'maxlength'=>'10', 'class'=>'software_input_text')) . '</td>
                </tr>
                <tr>
                    <td>Country*</td>
                    <td>' . $liveform->output_field(array('type'=>'select', 'name'=>'country', 'id'=>'country', 'options'=>$country_options, 'class'=>'software_select', 'onchange'=>'change_states(\'country\', \'state\')')) . '<script type="text/javascript" language="JavaScript 1.2">change_states(\'country\', \'state\', true);</script></td>
                </tr>
                <tr>
                    <td>Phone*</td>
