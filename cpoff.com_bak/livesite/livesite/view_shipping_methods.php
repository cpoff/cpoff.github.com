...
while ($row = mysqli_fetch_array($result)) {
    ...
    if ($row['adjust_transit']) {
        $adjust_transit = '<img src="images/check_mark.gif" width="7" height="7" alt="check mark" title="" />';
    } else {
        $adjust_transit = '';
    }
    ...
    $output_rows .=
        '<tr class="pointer" onclick="window.location.href=\'' . $output_link_url . '\'">
            ...
            <td>' . prepare_form_data_for_output($start_time, 'date and time') . '</td>
            <td>' . prepare_form_data_for_output($end_time, 'date and time') . '</td>
            ...
            <td style="text-align: center;">' . $adjust_transit . '</td>
...
<div id="content">
    ...
    <table class="chart">
        <tr>
            ...
            <th>' . asc_or_desc('Status','view_shipping_methods') . '</th>
            <th>' . asc_or_desc('Start Time','view_shipping_methods') . '</th>
            <th>' . asc_or_desc('End Time','view_shipping_methods') . '</th>
            <th>' . asc_or_desc('Real-Time Rate','view_shipping_methods') . '</th>
            ...
            <th style="text-align: right;">' . asc_or_desc('Transit Days','view_shipping_methods') . '</th>
            <th style="text-align: center;">' . asc_or_desc('Adjust Transit','view_shipping_methods') . '</th>
