    ...
    echo
        ...
        <html lang="en">
            ...
            <body class="files">
                <div id="content">
                    <h1>Modify Files</h1>
                    <div class="subheading" style="margin-bottom: 1em">You may update the selected Files via the form below. You may leave an option unselected if you do not want to modify a property.</div>
                    <table class="field">
                        <tr>
                            <td>Folder:</td>
