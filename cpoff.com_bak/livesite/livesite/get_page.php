                    ...
                    if (check_if_pretty_urls_are_enabled($form_list_view['custom_form_page_id']) == true) {
                        ...
                        $_GET['r'] = db_value(
                            ...
                            WHERE
                                ...
                                AND (address_name = '" . escape($address_name) . "')");
                    }
...
if ((ECOMMERCE == true) && ($_GET['o'])) {
    $_SESSION['ecommerce']['special_offer_code'] = $_GET['o'];
}
...
if (
    ...
    $_SESSION['ecommerce']['special_offer_code'] = $_GET['a'];
}
                    ...
                    foreach ($products as $product) {
                        ...
                        if ($product['selection_type'] != 'donation') {
                            ...
                            if (isset($discounted_product_prices[$product['id']]) == true) {
                                $output_sale_price = '<g:sale_price>' . sprintf("%01.2lf", $discounted_product_prices[$product['id']] / 100) . ' USD</g:sale_price>';
                            }
                            ...
                            $output_rss_items .=
                                '<item>
                                    ...
                                    ' . $output_image_link . '
                                    <g:price>' . sprintf("%01.2lf", $product['price'] / 100) . ' USD</g:price>
                                    ' . $output_sale_price . '
    ...
    if ($toolbar == TRUE) {
        ...
        $output_css = '
            <style>
                ...
                input.toggle_button_on:link,
                input.toggle_button_on:visited,
                input.toggle_button_on:hover,
                input.toggle_button_on:active            
                {
                    ...
                    white-space: nowrap;
                    color: #fff;
                    background: #000 url(' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/images/grid_toggle_on.png) no-repeat center !important;
                    padding: 0;
                    margin: 0;
                    border: 1px solid #629d1f !important;
                ...
                input.toggle_button_off:link,
                input.toggle_button_off:visited,
                input.toggle_button_off:hover,
                input.toggle_button_off:active
                {
                    display: inline-block;
                    position: fixed; 
                    right: 44px;
                    ...
                    white-space: nowrap;
                    color: #fff;
                    background: #000 url(' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/images/grid_toggle_off.png) no-repeat center !important;
                    padding: 0;
                    margin: 0;
                    border: 1px solid #629d1f !important;
                    text-decoration: none;
                ...
                input.up_button,
                input.up_button:link,
                input.up_button:visited,
                input.up_button:hover,
                input.up_button:active
                {
                    display: inline-block;
                    position: fixed; 
                    right: 0px;
                    ...
                    white-space: nowrap;
                    color: #fff;
                    background: #000 url(' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/images/toolbar_up_arrow.png) no-repeat center !important;
                    padding: 0;
                    margin: 0;
                    border: 1px solid #629d1f !important;
                    text-decoration: none;
                ...
                input.down_button,
                input.down_button:link,
                input.down_button:visited,
                input.down_button:hover,
                input.down_button:active
                {
                    display: inline-block;
                    position: fixed; 
                    right: 0px;
                    ...
                    white-space: nowrap;
                    color: #fff;
                    background: #000 url(' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/images/toolbar_down_arrow.png) no-repeat center !important;
                    padding: 0;
                    margin: 0;
                    border: 1px solid #629d1f !important;
                    text-decoration: none;
...
function init_tracking() {
    ...
    if ($_GET['utm_source']) {
        ...
        $_SESSION['software']['utm_source'] = $_GET['utm_source'];
        $_SESSION['software']['utm_medium'] = $_GET['utm_medium'];
        $_SESSION['software']['utm_campaign'] = $_GET['utm_campaign'];
        $_SESSION['software']['utm_term'] = $_GET['utm_term'];
        $_SESSION['software']['utm_content'] = $_GET['utm_content'];
