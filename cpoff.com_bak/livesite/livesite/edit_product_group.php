    ...
    echo
        ...
        <div id="content">
            ...
            <form name="form" action="edit_product_group.php" method="post" class="product_group_form">
                ...
                <div class="buttons">
                    <input type="submit" name="submit_button" value="Save" class="submit-primary">' . $output_delete_button . '&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" OnClick="javascript:history.go(-1);" class="submit-secondary">
                </div>
