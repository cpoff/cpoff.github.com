...
if (!$_POST[name]) {
    ...
    // show optimize button in button bar.
    ...
    echo
        ...
        <div id="content">
            ...
            <form action="edit_design_file.php" method="post">
                ...
                <div class="buttons">
                    <input type="submit" name="submit_save" value="Save" class="submit-primary" />&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" OnClick="window.location=\'' . OUTPUT_PATH . OUTPUT_SOFTWARE_DIRECTORY . '/view_design_files.php\'" class="submit-secondary">' . $output_edit_file_button . '&nbsp;&nbsp;&nbsp;<input type="button" name="download" value="Download File" onclick="window.open(\'' . OUTPUT_PATH . $file_name . '\')" class="submit-secondary">&nbsp;&nbsp;&nbsp;<input type="submit" name="delete" value="Delete" class="delete" onclick="return confirm(\'WARNING: This design file will be permanently deleted.\')" />
                </div>
            </form>
        </div>
        ' . output_footer();
