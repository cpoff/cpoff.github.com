...
function get_order_receipt($properties) {
    ...
    if (!$order_id) {
        ...
        $form->mark_error('', 'Sorry, it appears that you have not completed an order yet.');
            ...
            $output_auto_registration =
                ...
                <div class="account data">
                    ...
                    <p>
                        ...
                        Temporary Password: ' . h($_SESSION['software']['auto_registration']['password']) . '
                    </p>
                </div>';
        }
