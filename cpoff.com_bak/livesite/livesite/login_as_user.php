...
// Remember that user is logged in as a different user,
// so we know later to not require user to change random password
// and also so we don't remove remember me login cookies when
// the user logs out from this different user account.
