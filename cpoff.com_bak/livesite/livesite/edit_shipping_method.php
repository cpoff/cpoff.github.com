        ...
        <div id="content">
            ...
            <form name="form" action="edit_shipping_method.php" method="post" onsubmit="prepare_selects(new Array(\'allowed_zones\'))">
                ...
                <table class="field">
                    ...
                    <tr>
                        <th colspan="2"><h2>Transit Details for Shipping Method</h2></th>
                    </tr>
                    <tr>
                        <td>Base Transit Days:</td>
                        <td colspan="2"><input type="text" name="base_transit_days" size="3" maxlength="10" value="' . $base_transit_days . '" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="vertical-align: top">Excluded Transit Dates:</td>
