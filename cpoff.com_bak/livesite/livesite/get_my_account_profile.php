...
function get_my_account_profile($properties = array()) {
    ...
    if ($layout_type == 'system' || !$layout_type) {
        ...
        // set blank for the first option of the county selection drop-down
        ...
        $result = mysqli_query(db::$con, $query) or output_error('Query failed.');
        while ($row = mysqli_fetch_assoc($result)) {
            $business_country_options[$row['name']] = $row['code'];
        }
                            ...
                            <div class="billing" style="margin-bottom: 1em">
                                ...
                                <table class="data">
                                    ...
                                    <tr>
                                        ...
                                        <td><div id="business_state_container">' . $form->output_field(array('type'=>'text', 'name'=>'business_state', 'id'=>'business_state', 'maxlength'=>'50', 'class'=>'software_input_text')) . '</div></td>
                                    </tr>
                                    <tr>
                                        <td>Zip / Postal Code&nbsp;</td>
                                        <td>' . $form->output_field(array('type'=>'text', 'name'=>'business_zip_code', 'maxlength'=>'50', 'class'=>'software_input_text')) . '</td>
                                    </tr>
                                    <tr>
                                        <td>Country</td>
                                        <td>' . $form->output_field(array('type'=>'select', 'name'=>'business_country', 'id'=>'business_country', 'options'=>$business_country_options, 'class'=>'software_select', 'onchange'=>'change_states(\'business_country\', \'business_state\')')) . '<script type="text/javascript" language="JavaScript 1.2">change_states(\'business_country\', \'business_state\', true);</script></td>
                                    </tr>
                                    ' . $output_timezone_row . '
                                </table>
                            </div>
