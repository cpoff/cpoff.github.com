...
define('ECOMMERCE_END_OF_DAY_TIME', mb_substr($row['ecommerce_end_of_day_time'], 0, 4));
...
if (!defined('LOGO_URL')) {
    define('LOGO_URL', PATH . SOFTWARE_DIRECTORY . '/images/logo.png');
}

// Check if we need to set a default value for control_panel_stylesheet_url
if (!defined('CONTROL_PANEL_STYLESHEET_URL')) {
    define('CONTROL_PANEL_STYLESHEET_URL', PATH . SOFTWARE_DIRECTORY . '/backend.'. ENVIRONMENT_SUFFIX . '.css');
}
...
// If ecommerce is enabled, then prepare currency values.
if (ECOMMERCE == true) {
    // Get base currency.
