...
if (!$_POST) {
    ...
    if (
        ...
        $express_order_shipping_address_and_arrival_page_id_row_style = 'display: none';
        ...
        switch($page_type) {
            ...
            case 'express order':
                ...
                $express_order_shipping_address_and_arrival_page_id_row_style = '';
        ...
        if (ECOMMERCE == true) {
            ...
            $output_ecommerce_page_type_properties =
                ...
                <tr id="express_order_shipping_address_and_arrival_page_id_row" style="' . $express_order_shipping_address_and_arrival_page_id_row_style . '">
                    <td>Shipping Address &amp; Arrival Page:</td>
                    <td><select name="express_order_shipping_address_and_arrival_page_id"><option value="">-Select-</option>' . select_page($express_order_properties['shipping_address_and_arrival_page_id'], 'shipping address and arrival') . '</select></td>
                </tr>
            ...
            if ((PHP_REGIONS === true) && (USER_ROLE < 2)) {
                $output_ecommerce_page_type_properties .=
            ...
            $output_ecommerce_page_type_properties .=
                '<tr id="shopping_cart_next_page_id_with_shipping_row" style="' . $shopping_cart_next_page_id_with_shipping_row_style . '">
                    ...
                    <td><select name="shopping_cart_next_page_id_with_shipping"><option value="">-Select Shipping Address &amp; Arrival Page-</option>' . select_page($shopping_cart_properties['next_page_id_with_shipping'], 'shipping address and arrival') . '</select></td>
                </tr>
                <tr id="shopping_cart_next_page_id_without_shipping_row" style="' . $shopping_cart_next_page_id_without_shipping_row_style . '">
                    ...
                    <td><select name="shopping_cart_next_page_id_without_shipping"><option value="">-Select Billing Information Page-</option>' . select_page($shopping_cart_properties['next_page_id_without_shipping'], 'billing information') . '</select></td>
                </tr>
...
// else -> process
    ...
    // else page was edited, not deleted
            ...
            if ($update_page_type == true) {
                ...
                switch($_POST['type']) {
                    ...
                    case 'express order':
                        ...
                        $current_express_order_form = db_value("SELECT form FROM express_order_pages WHERE page_id = '" . escape($_POST['id']) . "'");
                        ...
                        $properties = array(
                            ...
                            'shipping_address_and_arrival_page_id' => $_POST['express_order_shipping_address_and_arrival_page_id'],
        ...
        if (
            ...
            || (($_POST['type'] == 'express order') && ($_POST['express_order_form'] == 1) && ($current_express_order_form != 1))
        ) {
            header('Location: ' . URL_SCHEME . HOSTNAME . PATH . SOFTWARE_DIRECTORY . '/view_fields.php?page_id=' . $_POST['id'] . '&send_to=' . urlencode($send_to));
