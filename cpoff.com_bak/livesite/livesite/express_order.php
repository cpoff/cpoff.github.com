...
if ($order_submitted == false) {
    ...
    if ($form == 1) {
        submit_custom_form(array('page_type' => 'express order', 'require' => false));
    }
    ...
    if (
        ...
        (
            ...
            && ($liveform->get_field_value('billing_zip_code') != '')
            ...
            (
                ...
                || (
                    ($require_state == true) 
                    && ($liveform->get_field_value('billing_state') != '')
                )
            )
        )
    ) {
        // get user id in order to see if user is logged in
