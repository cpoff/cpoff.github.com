...
if (!$_POST) {
    ...
    // else the menu was not selected for delete
        ...
        $query =
            ...
            SET
                name = '" . escape($liveform->get_field_value('name')) . "',
                effect = '" . escape($liveform->get_field_value('effect')) . "',
                first_level_popup_position = '" . escape($liveform->get_field_value('first_level_popup_position')) . "',
                second_level_popup_position = '" . escape($liveform->get_field_value('second_level_popup_position')) . "',
